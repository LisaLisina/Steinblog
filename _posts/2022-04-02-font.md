...
## ![window]({{ "/assets/font/window.png" | relative_url }}) ![church]({{ "/assets/font/church.png" | relative_url }})

# ![RT]({{ "/assets/font/RT.png" | relative_url }})
...
![crashpad]({{ "/assets/font/crashpad.png" | relative_url }})
...
![book]({{ "/assets/font/book.png" | relative_url }})
...
<iframe width="512" height="250" src="{{ "/assets/font/6c.mp4" | relative_url }}" frameborder="0" allowfullscreen></iframe>

We met a crocodile in the forrest and barely escaped its teeth.
<iframe width="512" src="{{ "/assets/font/crocodile.mp4" | relative_url }}" frameborder="0" allowfullscreen></iframe>
...
![palace]({{ "/assets/font/palace.png" | relative_url }})

![infinity-brunnen]({{ "/assets/font/infinity-brunnen.png" | relative_url }})

#### Samois-sur-Seine
Our landlord recommended us to visit the riverbanks of Samois-sur-Seine, which was definitely worth the trip.

## ![Samois]({{ "/assets/font/Samois.png" | relative_url }}) ![treehouse]({{ "/assets/font/treehouse.png" | relative_url }})

## ![swan]({{ "/assets/font/swan.png" | relative_url }}) ![smst]({{ "/assets/font/smst.png" | relative_url }})

### Where to eat
* Antica Trattoria, Fontainebleau - Italian restaurant run by an Italian family, the Pizza was amazing
* Fites-N-Bleau, Fontainebleau - delicious chips, the vegan *fricadelle* was a very good vegan sausage
...
[![boulanger]({{ "/assets/font/boulanger.png" | relative_url }})](https://www.autourdefontainebleau.fr/listings/papilles-enchantees/)
